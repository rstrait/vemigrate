...
pub const SIMPLE_STRATEGY: &'static str = "SimpleStrategy";
pub const NETWORK_TOPOLOGY_STRATEGY: &'static str = "NetworkTopologyStrategy";
...
const QUERY_GET_ALL: &'static str = "select id, up from vemigrate.migrations";
const QUERY_STORE_ONE: &'static str = "insert into vemigrate.migrations (id,up) values (?, ?);";
...
impl Database {
    ...
    pub fn initial_migration_up(
        ...
        format!(r#"-- This file is automatically generated by `vemigrate-cli`. Do not edit directly.
        ...
        create table if not exists vemigrate.migrations (
            ...
            up boolean,
            primary key(id)
        ) WITH CLUSTERING ORDER BY (timestamp DESC);"#, replication_strategy, replication_factor)
    }
...
impl vemigrate::Store for Database {
    ...
    fn get_all(&self) -> DbResult<Option<Vec<MigrationRow>>> {
        self.conn
            ...
            .map(|r| if r.len() == 0 { None } else { Some(r) })
    }
